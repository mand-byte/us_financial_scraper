    ...
    for row in rows:
        ...
        try:
            ...
            if time_el:
                ...
                if t_text: current_time_str = t_text
                ...
                try:
                    ...
                    if current_time_str:
                        if 'am' in current_time_str or 'pm' in current_time_str:
                            ...
                            if t_match:
                                hh, mm, ampm = int(t_match.group(1)), int(t_match.group(2)), t_match.group(3)
                                if ampm == 'pm' and hh < 12: hh += 12
                                if ampm == 'am' and hh == 12: hh = 0
                                dt = dt.replace(hour=hh, minute=mm)
                        elif 'all day' in current_time_str or 'tentative' in current_time_str:
